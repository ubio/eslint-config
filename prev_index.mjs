...
export const baseConfig = {
    ...
    rules: {
        '@typescript-eslint/ban-types': 0, // deprecated
        ...
        '@typescript-eslint/interface-name-prefix': 0, // I in interface naming
        ...
        '@typescript-eslint/no-this-alias': 0, // Disallow aliasing this.
        '@typescript-eslint/no-use-before-define': 0, // Disallow the use of variables before they are defined
        '@typescript-eslint/no-var-requires': 0, // deprecated in favour of the @typescript-eslint/no-require-imports // Disallow require statements except in import statements.

        'array-bracket-spacing': [2, 'never'],  // deprecated, should use array-bracket-spacing from stylistic
        'arrow-body-style': 0, // Require braces around arrow function bodies
        'brace-style': 0, // deprecated // Enforce consistent brace style for blocks
        'class-methods-use-this': 0, // Enforce that class methods utilize this
        'comma-dangle': 0, // deprecated // Require or disallow trailing commas
        ...
        eqeqeq: [2, 'always', { //the intent is to use ===/!== everywhere except when checking for null
            null: 'never',
        }],
